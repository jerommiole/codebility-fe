...
const Contain: React.FC<ContainProps> = ({ children }) => {
  ...
  return (
    <div className="ml-[103px] flex h-screen flex-col overflow-hidden bg-background tablet:ml-0">
      {/* Header */}
      ...
      <div className={`flex min-h-0 flex-1`}>
        <div className={`flex-1 ${!activeNav ? "overflow-y-auto" : "overflow-y-hidden"} p-0 sm:p-4 sm:pb-20`}>
          {children}
        </div>
      </div>
    </div>
