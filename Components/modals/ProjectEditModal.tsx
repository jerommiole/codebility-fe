            ...
            <div className="mt-4 space-y-8 md:mt-0 md:space-y-4">
              <div>
                <div>
                  ...
                  <Input id="projectName" placeholder="Project Name" value="Lorem Ipsum" />
                </div>
                <div>
                  <Label className="text-gray" htmlFor="client">
                    Client
                  </Label>
                  <Input id="client" placeholder="Client Name" value="Mr. Lorem Ipsum" />
                </div>
                <div>
                  <Label className="text-gray" htmlFor="githubLink">
                    Github Link
                  </Label>
                  <Input id="githubLink" placeholder="Link" value="https://github.com/" />
                </div>
                <div>
                  <Label className="text-gray" htmlFor="productionLink">
                    Production Link
                  </Label>
                  <Input id="productionLink" placeholder="Link" value="https://www.codebility.tech/" />
                </div>
                ...
                <div>
                  ...
                  <Textarea
                    id="summary"
                    value="Lorem, ipsum dolor sit amet consectetur adipisicing elit. Suscipit illum maiores repudiandae similique soluta ex, saepe aut quasi nobis sapiente temporibus expedita officiis a repellat ducimus recusandae deleniti quam esse."
                  />
                </div>
              </div>
            </div>
