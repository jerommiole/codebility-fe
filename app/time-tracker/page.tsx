...
import icon1 from "../../public/icons/Vector1.svg"
import icon2 from "../../public/icons/Vector2.svg"
import icon3 from "../../public/icons/Vector3.svg"
import icon4 from "../../public/icons/Vector4.svg"
import { DataTableDemo } from "./data-table"

const page = () => {
  return (
    <div className="h-screen w-screen overflow-x-auto bg-[#0E0E0E]">
      <Sidebar />
      <Card className=" ml-[7.5%] mr-3 mt-14 flex w-auto flex-col items-center justify-between  overflow-hidden border bg-[#0E0E0E] md:flex-row">
        <div className="px-[2.50rem] py-[1.75rem] sm:pl-12">
          <h1 className="text-2xl font-semibold">Summary Of Rendered Time</h1>
          <p className="text-[#8E8E8E] ">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
        </div>
      ...
      <Card className="ml-[7.5%] mr-3 mt-[0.75rem] bg-[#0E0E0E]">
