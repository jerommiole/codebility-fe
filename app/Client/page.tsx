...
export default function Web() {
  return (
    <>
      <Sidebar />
      <Contain>
        <div className="shadow-stiglitz w-[100%] overflow-x-hidden rounded-md border bg-figmamuted dark:border-none lg:h-[100%] lg:overflow-y-hidden lg:px-[17px] lg:py-[51px]">
