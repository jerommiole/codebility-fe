...
const ProjectsCompleted = () => {
  return (
    <div className="mx-auto flex w-screen max-w-7xl flex-col gap-5 py-14">
      ...
      <div className="flex w-full flex-col items-start justify-center gap-5 md:justify-start xl:mx-auto xl:w-[80%]">
      ...
      {/* COMPLETED PROJECTS */}
      <div className="mx-auto mt-5 grid h-96 w-80  grid-cols-1 place-items-center gap-y-5 overflow-y-scroll text-center md:h-[600px] md:w-screen md:grid-cols-2 md:p-10 lg:grid-cols-3 lg:p-0 xl:h-[485px] xl:w-[85%] xl:gap-x-0">
        {projects.map((project) => (
          <div
            key={project.projectId}
            className="relative flex w-80 flex-col gap-3 rounded-sm bg-slate-100 p-4 dark:bg-[#131313]"
          >
            <div className="h-40">
              <Image
