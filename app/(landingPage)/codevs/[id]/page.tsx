            ...
            <div>
              ...
              <div className="flex flex-col gap-2 lg:flex-row lg:gap-10">
                ...
                <div className="my-auto flex flex-col gap-2 text-secondaryColor">
                  ...
                  <p className="text-xs lg:text-sm">
                    At Codebility, we undertook a dynamic and comprehensive project to design and develop a feature-rich
                    website, seamlessly integrating an eye-catching landing page with a robust Content Management System
                    (CMS). This project aimed to provide Codebility with a modern and user-friendly online presence,
                    enabling efficient content management and easy navigation for both visitors and administrators.
                  </p>
