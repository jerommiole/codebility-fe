    ...
    <SectionWrapper id="about">
      ...
      <div className="flex flex-col gap-10 lg:flex-row">
        <div className="flex basis-1/2 flex-col justify-center gap-6">
          ...
          <IntroText>
            We believe in the transformative power of coding. With Codebility, you won't just learn coding; you'll wield
            a tool for a brighter future. Join us in sculpting your path as tomorrow's digital architect.
          </IntroText>
        </div>
