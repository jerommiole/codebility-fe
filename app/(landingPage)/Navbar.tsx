        ...
        <div className="flex items-center justify-between border-b border-zinc-900 py-6 ">
            ...
            <div className="hidden lg:flex">
              <Link href="/">
                <motion.div variants={item}>
                  <Image src="/assets/svgs/codebility-blue.svg" alt="CodebilityLogo" width={147} height={30} />
                </motion.div>
              </Link>
            </div>
          ...
          <div className="flex w-full flex-row-reverse items-center justify-between px-5 lg:hidden ">
            ...
            <div className="block lg:hidden">
              <Link href="/">
                <Image src="/assets/svgs/codebility-blue.svg" alt="Codebility Logo" width={110} height={49} />
              </Link>
            </div>
          </div>
